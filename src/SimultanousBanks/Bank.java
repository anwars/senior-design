...
public class Bank {
	...
	private HashMap<Bank, Double> debtToBank;
	private ArrayList<Bank> creditorBanks;
	private HashMap<Bank, Double> creditToBank;
	private double cash;
	private int shock;
	private int seniorObligations;
	
	public Bank(String name, double cash){
		this.name = name;
		this.cash = cash;
		creditorBanks = new ArrayList<Bank>();
		debtorBanks = new ArrayList<Bank>();
		debtToBank = new HashMap<Bank, Double>();
	}
	...
	public void addDebtor(Bank bank, double debt){
		debtToBank.put(bank, debt);
		//debtorBanks.add(bank);
	}
	
	public void addCreditor(Bank bank, double debt){
			...
			if (hasCreditors()){
				...
				for (Bank Cred : creditors){
					...
					//if (!insufficientFunds()){//we have enough money
						...
						HashMap<Bank, Double> bankDividends = new HashMap<Bank, Double>();
